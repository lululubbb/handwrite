      ...
      <el-main class="main-content">
        <div class="dashboard-section">
            ...
            <el-col :span="12">
              <el-card class="stat-card" shadow="hover">
                ...
                <el-descriptions :column="2" border>
                  <el-descriptions-item label="今日上传">{{ stats.today?.uploads || 0 }}</el-descriptions-item>
                  <el-descriptions-item label="今日字符">{{ stats.today?.characters || 0 }}</el-descriptions-item>
                </el-descriptions>
              </el-card>
            </el-col>
            <el-col :span="12">
              <el-card class="stat-card" shadow="hover">
                <template #header><span>本周统计</span></template>
                <el-descriptions :column="2" border>
                  <el-descriptions-item label="本周上传">{{ stats.week?.uploads || 0 }}</el-descriptions-item>
                  <el-descriptions-item label="本周字符">{{ stats.week?.characters || 0 }}</el-descriptions-item>
                </el-descriptions>
              </el-card>
            </el-col>
          </el-row>
          ...
          <el-card class="top-users-card" shadow="hover" style="margin-top: 20px">
            <template #header><span>活跃用户TOP 10</span></template>
            <el-table v-loading="loading" :data="topUsers" stripe style="width: 100%">
...
import { HomeFilled, Upload, User, Setting, SwitchButton, Document } from '@element-plus/icons-vue'
...
.dashboard-section h2 { font-size: 28px; color: #303133; margin-bottom: 20px; }

.stat-card { min-height: 100px; }

.stat-content { display: flex; align-items: center; }

.stat-icon { font-size: 48px; color: #667eea; margin-right: 20px; }
...
.top-users-card { margin-top: 20px; }
.top-users-card :deep(.el-card__header) { padding: 15px 20px; }
</style>